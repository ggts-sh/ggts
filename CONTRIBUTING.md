...
1. **bun** — the package manager, script runner, and unit-test runner.
   ...
   **bun 1.4.2**). Install with `mise install` or <https://bun.sh> →
...
| Tool                                         | Version                | Role                                                                               |
| -------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------- |
| bun                                          | 1.4.2 (pinned)         | PM / runner / unit tests                                                           |
...
| @changesets/cli                              | 3.0.3                  | versioning/release (all seven packages in fixed lockstep, access public)           |
...
| `bun run benchmark:charts:gen` / `bun run benchmark:charts:check` | regenerate / check homepage benchmark SVGs, projection, and README from committed measurements; pass `--publish` to the generator to promote measured results          |
